const struct Evolution gEvolutionTable[NUM_SPECIES][EVOS_PER_MON] =
{
    ...
    [SPECIES_CHANSEY]    = {{EVO_LEVEL, 36, SPECIES_BLISSEY}},
    [SPECIES_HORSEA]     = {{EVO_LEVEL, 32, SPECIES_SEADRA}},
    [SPECIES_SEADRA]     = {{EVO_LEVEL, 43, SPECIES_KINGDRA}},
    ...
    [SPECIES_LOUDRED]    = {{EVO_LEVEL, 36, SPECIES_HUNTAIL},
